 ...
 */
 ...
 process convert_twostep_ref_to_xcf {
    ...
    output:
        tuple val(metaRef), path(referencePath), path(referenceIndexPath), path("${referencePath.baseName}_${chromosomeNum}_xcf.bcf"), path("${referencePath.baseName}_${chromosomeNum}_xcf.bcf.csi"), path("${referencePath.baseName}_${chromosomeNum}_xcf.bin"), path("${referencePath.baseName}_${chromosomeNum}_xcf.fam"), emit: xcfTwostepReference
