...
- 'use_pedigree' : SHAPEIT5_phase_common will run to perform phasing, using the user-supplied pedigree information provided with the input test samples. Note that the individual IDs should align between the pedigree and input files.
